...
var authMiddleware = createMiddleware(async (c, next) => {
  ...
  try {
    ...
    return c.json({ error: `Invalid token: ${message2}` }, 403);
  }
});
...
// .wrangler/tmp/bundle-DahIoB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DahIoB/middleware-loader.entry.ts
